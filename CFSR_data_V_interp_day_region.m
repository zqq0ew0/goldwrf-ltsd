...
%         t2m_prc(:,:,ntime)=squeeze(data_prc.data('TMP_HTGL',[ntime,1,1],[ntime,num_lat_prc,num_lon_prc]))';     
        z0=data_prc.data('HGT_ISBL',[ntime,1,1,1],[ntime,16,num_lat_prc,num_lon_prc]); %重力势能 压强越大，势能越小 16个等压面数据，从500~1000hpa
        v0=data_prc.data('V_GRD_ISBL',[ntime,1,1,1],[ntime,16,num_lat_prc,num_lon_prc]);
        u0=data_prc.data('U_GRD_ISBL',[ntime,1,1,1],[ntime,16,num_lat_prc,num_lon_prc]);
