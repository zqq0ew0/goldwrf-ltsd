...
path_raw = '/mnt/static_data/CFSR/code/'
path_out = '/mnt/static_data/CFSR/mat_p2/'
...
for n_url in range(s_url,len(url_pre)):
    ...
    topo0 = data_sfc.variables['HGT_SFC'][0:1,:,:]
#    z0 = data_prc.variables['HGT_ISBL'][0:10,0:16,:,:] #重力势能 压强越大，势能越小 16个等压面数据，从500~1000hpa
#    v0 = data_prc.variables['V_GRD_ISBL'][0:10,0:16,:,:]
#    u0 = data_prc.variables['U_GRD_ISBL'][0:10,0:16,:,:]
